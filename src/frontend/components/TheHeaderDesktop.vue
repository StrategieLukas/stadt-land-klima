<template>
  ...
  >
    ...
    >
      ...
      <NuxtLink
        to="/"
        class="h-12 shrink-0 overflow-hidden transition-[height] duration-300 ease-in-out"
      ...
      >
        ...
        >
          ...
          <span
            ...
            class="pointer-events-none hidden flex-shrink-0 items-center gap-0.5 md:inline-flex"
          >
            <kbd class="kbd kbd-xs">Ctrl</kbd><span class="text-gray-400 text-[10px]">+</span
      ...
      <div class="relative z-10 ml-auto flex items-center gap-2">
        ...
        <a href="/backend" class="hidden sm:flex 2xl:hidden">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 141.7 141.7" class="h-5 w-5" aria-hidden="true">
              <polygon
                fill="currentColor"
                points="72.8,103.7 78.3,109.2 116.5,71 78.3,32.8 72.8,38.3 90.3,55.8 37.1,55.8 37.1,63.5 98.1,63.5 105.5,71 98.1,78.4 37.1,78.4 37.1,86.2 90.3,86.2"
              />
            </svg>
          </button>
        </a>
        ...
        >
          <button
            class="flex h-9 w-9 items-center justify-center rounded-md bg-orange text-white shadow-sm transition-all hover:brightness-110"
          >
    ...
    <div
      ref="navStripClipRef"
      class="hidden overflow-hidden transition-[max-height] duration-300 ease-in-out sm:block"
