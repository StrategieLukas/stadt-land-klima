      ...
      <div class="lg:col-span-1">
        <div class="sticky top-8 space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            <h3 class="font-heading text-h3 text-green mb-4">{{ municipality?.name || 'Unbekannte Gemeinde' }}</h3>
          ...
          <div v-if="municipality?.description" class="collapse-plus collapse rounded-sm p-2 px-0 shadow-list md:px-2">
            <input type="checkbox" name="about-accordion" autocomplete="off" />
            ...
            <div class="collapse-content px-2 md:px-4">
              <div class="has-long-links prose prose-sm max-w-none" v-html="sanitizeHtml(linkifyStr(municipality.description))"></div>
            </div>
          </div>
