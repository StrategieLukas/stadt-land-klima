<template>
    <div class="dock dock-xl bg-white/80 backdrop-blur-lg border-t border-gray-200 text-color-black flex justify-around items-center">
        <button 
            ...
            class="flex flex-col items-center min-w-0 min-h-[48px]"
        >
        ...
        <button 
            ...
            class="flex flex-col items-center min-w-0 min-h-[48px]"
        >
            <svg class="size-[1.2em] w-[24px] h-[24px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
