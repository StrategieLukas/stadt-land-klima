  ...
  <div class="min-h-screen bg-mild-white">
    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
      ...
      <div v-else-if="publicElections.length === 0" class="bg-orange/10 border border-orange text-orange-800 p-8 rounded-xl text-center my-12">
        ...
        <h2 class="text-2xl font-bold mb-4">{{ $t("elections.no_public_elections.title") }}</h2>
        ...
        <div class="bg-ff-green/5 p-8 rounded-xl border border-ff-green/20 mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
              ...
              <h4 class="font-bold text-stats-dark mb-2">{{ $t('elections.wahlcheck.how_it_works.step1.title') }}</h4>
            ...
            <div class="text-center">
              ...
              <h4 class="font-bold text-stats-dark mb-2">{{ $t('elections.wahlcheck.how_it_works.step2.title') }}</h4>
              <p class="text-sm text-mid-gray">
            ...
            <div class="text-center">
              ...
              <h4 class="font-bold text-stats-dark mb-2">{{ $t('elections.wahlcheck.how_it_works.step3.title') }}</h4>
              <p class="text-sm text-mid-gray">
