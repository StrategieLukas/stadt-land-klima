 ...
 */
function matchesWildcardPattern(fieldName: string): boolean {
...
interface ExportSettingsOptions {
  verbose?: boolean;
  overwrite?: boolean;
}

async function exportSettings(dest: string, options: ExportSettingsOptions = { verbose: false, overwrite: false }): Promise<void> {
