...
import clearSchema from './clearSchema.js';
import exportRoles from './exportRoles.js';
import exportPolicies from './exportPolicies.js';
import exportPresets from './exportPresets.js';
import exportFlows from './exportFlows.js';
import exportTranslations from './exportTranslations.js';
import exportSettings from './exportSettings.js';
import exportCollectionItems from './exportCollectionItems.js';
...
async function clear(dest: string, options: ClearOptions = { verbose: false }): Promise<void> {
  try {
...
interface ExportArgv extends ExportOptions {
  dest: string;
}

interface ExportAllArgv extends ExportOptions {
  dest: string;
}

function exportTasks(yargs: any) {
  return yargs
    .command(
      'export:schema [dest]',
