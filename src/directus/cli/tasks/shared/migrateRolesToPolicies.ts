 ...
 *
 * Usage: node migrateRolesToPolicies.ts /path/to/roles/folder /path/to/policies/folder
 */
...
async function migrateRolesToPolicies(rolesSrc: string, policiesDest: string): Promise<void> {
