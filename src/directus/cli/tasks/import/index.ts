...
import importRoles from './importRoles.js';
import importPolicies from './importPolicies.js';
import importRolesAndPolicies from './importRolesAndPolicies.js';
import importPresets from './importPresets.js';
import importFlows from './importFlows.js';
import importTranslations from './importTranslations.js';
import importSettings from './importSettings.js';
import importCollectionItems from './importCollectionItems.js';
...
interface ImportArgv extends ImportOptions {
  src: string;
}

function importTasks(yargs: any) {
  return yargs
    .command(
      'import:schema [src]',
