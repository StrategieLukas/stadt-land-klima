...
#let draw_overview_table(municipalityScore, sorted_measures) = (
table(
    ...
    [*EN - Energie*],
    progress_bar.draw_progress_bar(municipalityScore.score_energy, progress_bar_height),
    ...
    progress_bar.draw_progress_bar(municipalityScore.score_buildings, progress_bar_height),
    ...
    progress_bar.draw_progress_bar(municipalityScore.score_industry, progress_bar_height),
    ...
    progress_bar.draw_progress_bar(municipalityScore.score_management, progress_bar_height),
    ...
    progress_bar.draw_progress_bar(municipalityScore.score_agriculture, progress_bar_height),
    ...
    [*VK - Verkehr*],
    progress_bar.draw_progress_bar(municipalityScore.score_transport, progress_bar_height),
